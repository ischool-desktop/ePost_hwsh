...
namespace SH_YearScoreReport_hwsh
{
    public partial class NewConfigure : FISCA.Presentation.Controls.BaseForm
    {
        ...
        private void SetupTemplate(object sender, EventArgs e)
        {
            ...
            {
                Template = new Aspose.Words.Document(new MemoryStream(Properties.Resources.惠文高中學年成績單樣版));
        ...
        {
            #region 儲存檔案
            string inputReportName = "個人學年成績單樣版";
            ...
            try
            {
                ...
                stream.Write(Properties.Resources.惠文高中學年成績單樣版, 0, Properties.Resources.惠文高中學年成績單樣版.Length);
                stream.Flush();
                stream.Close();
        ...
        {
            #region 儲存檔案
            string reportName = "個人學年成績單合併欄位總表";
            ...
            {
                System.IO.FileStream stream = new FileStream(path, FileMode.Create, FileAccess.Write);
                stream.Write(Properties.Resources.惠文高中學年成績單合併欄位總表, 0, Properties.Resources.惠文高中學年成績單合併欄位總表.Length);
                stream.Flush();
                stream.Close();
                System.Diagnostics.Process.Start(path);
            }
